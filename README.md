# nvim-treesitter-queries-json5

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-json5/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-json5/actions/workflows/validate.yml)

Neovim tree-sitter queries for **json5**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-json5",
...
- [ ] Changes are scoped to `json5` — do not include files for other languages
